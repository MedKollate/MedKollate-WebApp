...
<head>
    ...
    <title>MedKollate || Patient Pharmacy </title>
    ...
    <div class="patient-procedure">
        <div class="patient-dashboard">
            ...
            <div>
                ...
                <a href="./patient-pharmacy.php" id="patient-active">
        ...
        <div class="patient-home">
            ...
            <div class="pharmacy">
                <a href="./view_drugs.html">View List of Drugs</a>
                <a href="./view_prescription.html">View New Prescription</a>
                <a href="./drug_reaction.html">Make Complaint of Drug Reaction</a>
            </div>
        </div>
    </div>
