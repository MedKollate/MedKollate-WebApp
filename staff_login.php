...
<head>
    ...
    <title>MedKollate || Staff Login</title>
    ...
    <div class="container">
       ...
       <section class="login">
            ...
            <div>
                ...
                <form class="login-form" action="includes/staff_login.inc.php" method="post">
                    <div>
                        <label for="id">
                            Email
                        </label>
                    ...
                    <div>
                        ...
                        <input type="password" placeholder="Enter staff ID here" name="pwd">
                    </div>
                   <div id="remember">
